# PRD: Drive With Nayyer MVP

## Problem Statement

Nayyer Sultana runs a women-only driving instruction business in Ontario, Canada under her own brand, Drive With Nayyer. Lessons are available in Mississauga, Oakville, Burlington, and Milton, with students asked to confirm before booking if they are outside the listed cities. She currently markets through Instagram and Facebook and receives inquiries through WhatsApp and direct messages. Many potential students ask about lesson availability but do not commit, creating wasted back-and-forth and unpaid time holds.

The business needs a mobile-first website that builds trust, explains the packages, and lets serious students choose an available booking slot and pay before the booking is confirmed.
...
Build a single-page, mobile-responsive Next.js marketing website for Drive With Nayyer. The site will present Nayyer as an MTO Certified Instructor offering women-only driving lessons in Ontario, Canada for G2 and G students, with lessons available in Mississauga, Oakville, Burlington, and Milton and support in English, Urdu, and Hindi.

The website will show the three service packages and route each package's booking button to a corresponding Cal.com paid booking flow. In Cal.com, the student selects an available booking slot, enters required student details, and pays through Stripe. The booking is only confirmed after successful payment. Remaining lesson details are coordinated manually by Nayyer after the initial booking, likely through WhatsApp.
...
5. As a prospective student, I want to see the listed service cities and know to confirm if I am outside them, so that I do not book without checking coverage.
...
7. As a prospective student, I want to see the BDE Program, so that I can understand the beginner education option and price.
8. As a prospective student, I want to see hourly driving lessons, so that I can book practice at the hourly rate.
9. As a prospective student, I want to see the road test vehicle option, so that I can reserve Nayyer's vehicle for my G2 or G road test.
...
12. As a prospective student, I want to choose my booking slot before paying, so that I know when my appointment will happen.
13. As a prospective student, I want the selected booking slot to be confirmed only after payment, so that the booking feels reliable and official.
...
16. As a prospective student, I want to know what happens after the paid booking, so that I understand how remaining details will be scheduled.
...
33. As Nayyer, I want the booking slot to be selected before purchase, so that I know when to meet the student.
...
37. As Nayyer, I want students to understand that remaining details are coordinated after booking, so that the website does not overpromise full package scheduling.
...
- In phase 1, Cal.com books the selected appointment slot for the purchased package.
- Payment happens after the slot is selected and before the booking is confirmed.
...
- The public brand will be Drive With Nayyer.
...
- The site will say lessons are available in Mississauga, Oakville, Burlington, and Milton, and students outside those cities should confirm availability before booking.
- The phone number will be 647-716-2153.
- The email will be kooolnayyer12@gmail.com.
- Displayed prices are $494 for the BDE Program, $52/hr for Hourly Driving Lessons, and $170-$220 for Road Test Vehicle.
...
- Multi-lesson scheduling for every lesson in a package.
...
- Brand: Drive With Nayyer.
- Instructor: Nayyer Sultana.
- Service: strictly women-only driving lessons.
- Location: Ontario, Canada.
- Listed lesson cities: Mississauga, Oakville, Burlington, and Milton.
...
- Final confirmation of all package terms and conditions.
...
Women-only driving lessons in Ontario, Canada
